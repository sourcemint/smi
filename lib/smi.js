...
exports.install = function (basePath, snapshotDescriptor, callback) {
	...
	function ensureDescriptor(callback) {
		if (typeof snapshotDescriptor === "object") {
			return callback(null, snapshotDescriptor);
		}
		return exports.readDescriptor(snapshotDescriptor, callback);
	}
	...
	//console.log("rsponse", locator.uri, response.statusCode, response.headers);
